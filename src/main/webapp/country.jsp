    ...
    <form action="country" method="post">
        <div class="form-group">
            <div class="form-group">
                ...
                <lablel for="name" >Country Name:</lablel>
                <input type="text" class="form-control" name="countryName" value="">
            </div>
            <br/>
            <div class="form-group">
                <lablel for="surname" >Nationality:</lablel>
                <input type="text" class="form-control" name="nationalityName" value="">
            </div>
            <div class="form-group">
